...
// LoggingOptions contains all options required for configuring the logging
...
// DefaultLoggingOptions creates a LoggingOptions populating each field with its default value
